package net.ostis.common.sctpclient.model.request;
...
public enum RequestHeaderType {
    ...
    CREATE_EVENT_SUBSCRIPTION(SctpCommandType.CREATE_EVENT_COMMAND, (byte) 0, 0),
    REMOVE_EVENT_SUBSCRIPTION(SctpCommandType.REMOVE_EVENT_COMMAND, (byte) 0, 0),
    EMIT_EVENTS(SctpCommandType.EMIT_EVENTS_COMMAND, (byte) 0, 0)
    ;
